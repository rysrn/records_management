<h1>The <?php echo $_settings->info('name') ?></h1>
<hr class="bg-light">
<div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total Offender's Listed</span>
                <span class="info-box-number text-right">
                  <?php 
                    $offenders = $conn->query("SELECT id FROM `offenders_list` ")->num_rows;
                    echo number_format($offenders);
                  ?>
                </span>
              </div>
              <!-- /.info-box-content -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total Offenses</span>
                <span class="info-box-number text-right">
                <?php 
