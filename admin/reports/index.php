        ...
        <div class="container-fluid" id="print_out">
			<table class="table table-hover table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT r.*,d.ID_no FROM `offense_list` r inner join `offenders_list` d on r.offender_id = d.id where date(r.date_created) between '{$date_start}' and '{$date_end}' order by unix_timestamp(r.date_created) desc ");
