        ...
        <div class="container-fluid">
			<table class="table table-hover table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT r.*,d.ID_no FROM `offense_list` r inner join `offenders_list` d on r.offender_id = d.id order by unix_timestamp(r.date_created) desc ");
...
<script>
	$(document).ready(function(){
		...
		$('.view_details').click(function(){
			uni_modal("<i class='fa fa-ticket'></i> Offender's Offense Ticket Details","offenses/view_details.php?id="+$(this).attr('data-id'),'mid-large')
		})
		$('.table').dataTable({
